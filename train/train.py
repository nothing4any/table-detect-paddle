...
sys.path.append('.')
from source.table_line import model
from tensorflow.keras.optimizers import Adam
from tensorflow.keras.callbacks import ModelCheckpoint, ReduceLROnPlateau
from sklearn.model_selection import train_test_split
from glob import glob
from source.image import gen

if __name__ == '__main__':
    filepath = '/opt/programs/python/table-detect-paddle/models/table-line-fine1.h5'  ##模型权重存放位置
    ...
    paths = glob('/opt/programs/python/table-detect-paddle/train/dataset-line/*/*.json')  ##table line dataset label with labelme
