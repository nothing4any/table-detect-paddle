            ...
            for index, box in enumerate(boxes):
                if len(line) == 0:
                    line.append(box.tolist())
                                                                                                     ...
                                                                                                     1)) <= 20:
                        #and abs(round(box[6], 1) - round(boxes[index - 1][4], 1)) <= 20
                    line.append(box.tolist())
...
def main():
    if request.method == 'POST':
        #try:
            ...
            #cv2.imwrite(filename='/home/tiandy/python/test2.png', img=img)
            # args = utils.parse_args(img)
        ...
        #    print("错误：{}".format(e))
        #    print("错误位置{}".format(e.__traceback__.tb_frame.f_globals['__file__']))
        #    print("错误行{}".format(e.__traceback__.tb_lineno))
        #    return jsonify({"enter_line": None, "lines": None})
